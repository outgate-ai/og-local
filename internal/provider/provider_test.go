...
func TestRoute(t *testing.T) {
	cases := []struct {
		...
		{"POST", "/backend-api/codex/responses", OpenAIResponses, true},
		{"POST", "https://chatgpt.com/backend-api/codex/responses", OpenAIResponses, true},
		{"GET", "/backend-api/codex/models", Passthrough, false},
